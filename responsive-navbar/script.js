...
gsap.from(".hero__image", {
  ...
  let titleOneWords = document.querySelectorAll(".hero__title--1 span");
  let titleTwoWords = document.querySelectorAll(".hero__title--2 span");
  
  gsap.from(titleOneWords, {
    opacity: 0,
    duration: 1.5,
    y: 80,
    ease: "power4",
